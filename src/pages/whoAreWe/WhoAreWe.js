...
const WhoAreWe = () => {
    ...
    return (
        <div className={`${style["page"]} full-width flex-col-top-start`}>
            ...
            <div data-aos='fade-up' className={style["divider"]} /> {/* Add a horizontal rule (line) */}
            <div data-aos='fade-up' className={`${style["vision"]} white flex-row-between2col`}>
                <p className={`${style["text"]} space-none size-20px inter margin-12px-H`}>
            ...
            <div data-aos='fade-up' className={style["divider"]} /> {/* Add a horizontal rule (line) */}
            <h1 data-aos='fade-up' className="size-34px pt-sans">What Sets Us Apart ?</h1>
            <div data-aos='fade-up' className={`${style['container']} flex-row-top-start2col full-width`}>
                <h3 className="margin-4px-V width-30-100 size-24px pt-sans">1- Diverse Expertise: </h3>
                <p className={`${style["text"]} space-none width-70-100 size-18px inter margin-12px-H`}>
            ...
            <div data-aos='fade-up' className={`${style['container']} flex-row-top-start2col full-width`}>
                <h3 className="margin-4px-V width-30-100 size-24px pt-sans">2- Collaborative Approach: </h3>
                <p className={`${style["text"]} space-none width-70-100 size-18px inter margin-12px-H`}>
            ...
            <div data-aos='fade-up' className={`${style['container']} flex-row-top-start2col full-width`}>
                <h3 className="margin-4px-V width-30-100 size-24px pt-sans">3- Innovation-Driven: </h3>
                <p className={`${style["text"]} space-none width-70-100 size-18px inter margin-12px-H`}>
            ...
            <div data-aos='fade-up' className={`${style['container']} flex-row-top-start2col full-width`}>
                <h3 className="margin-4px-V width-30-100 size-24px pt-sans">4- Client-Centric Focus: </h3>
                <p className={`${style["text"]} space-none width-70-100 size-18px inter margin-12px-H`}>
