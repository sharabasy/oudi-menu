    ...
    return (
        <div className={`${style['page']} full-width flex-col-top-start`}>
            ...
            <div className={`${style['services']} full-width shadow-5px radius-10px`}>
                <ScrollAnimation duration={2} animateIn="fadeIn" animateOnce={false} offset={300} animatePreScroll={false} className={`${style['service']} flex-row-between full-width`}>
                ...
                <ScrollAnimation duration={2} animateIn="fadeIn" animateOnce={false} offset={300} animatePreScroll={false} className={`${style['service']} ${style['reverse']} flex-row-between full-width`}>
                    <div className={`${style['piece']} ${style['piece--description']} baby-blue-bg radius-10px flex-row-center`}>
